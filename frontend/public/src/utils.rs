...
pub fn page(title: impl Into<String>, children: Markup) -> Markup {
    ...
    html! {
        html lang="de" {
            head {
                ...
                link href="/static/favicon.svg" rel="mask-icon" ;

                link href="/static/style/albert-sans.css" rel="stylesheet" ;
                link href="/static/style/body.css" rel="stylesheet" ;
                link href="/static/style/menu.css" rel="stylesheet" ;
                link href="/static/style/typography.css" rel="stylesheet" ;
            ...
            body {
                nav."bamboo-menu" {
                    a."bamboo-menu__item is--logo" href="/" {
                        svg."bamboo-logo" viewBox="0 0 512 512" {
                    ...
                    a."bamboo-menu__item" href="/" {
                        "Über Bambushain"
                    }
                    a."bamboo-menu__item" href="/register" {
                        "Registrieren"
                    }
                    a."bamboo-menu__item is--right" href="/pandas" {
                        "Zu den Pandas"
                    }
                }
                div."bamboo-page" {
                    (children)
                    footer."bamboo-footer" {
                        div {
                            (format!("© Bambushain Team {}", chrono::Local::now().year()))
                        }
                        div {
                            "Made with "
                            span."bamboo-heart" {
...
pub fn banner_page(title: impl Into<String> + Clone, children: Markup) -> Markup {
    page(
        title.clone(),
        html! {
            div."bamboo-banner__container" {
                img."bamboo-banner" src="/static/background.webp" {}
                span."bamboo-banner__title" {
                    (title.into())
                }
            }
