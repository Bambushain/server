...
pub fn App() -> impl IntoView {
    ...
    view! {
        ...
        <Router>
            <nav class="bamboo-menu">
                <a class="bamboo-menu__item is--logo">
                    <svg viewBox="0 0 512 512" class="bamboo-logo">
                ...
                <a class="bamboo-menu__item is--right" href="/pandas">"Zu den Pandas"</a>
            </nav>
